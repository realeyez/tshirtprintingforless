...
$base_url = 'http://tshirtprintingforless.co.uk';

//D6 DB config
$db_url = 'mysqli://tshirtprinting@localhost:33066/tshirtprintingforless';

//D7 DB config
$databases = array('default' => array('default' => array(
    'driver' => 'mysql',
    'database' => 'tshirtprintingforless',
    'username' => 'tshirtprinting',
    'password' => 'tshirtprintingforless78687gyg',
    'host' => 'localhost',
    'port' => 8443 
    )));
//</@@ADCP_CONF@@>
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_drup_local.inc'))
  require($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_drup_local.inc');
//</DDSETTINGS>
